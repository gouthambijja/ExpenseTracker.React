...
const DeleteTransaction = ({ isOpen, onClose, transaction }) => {
  ...
  const handleDelete = (e) => {
    ...
    try {
      ...
      toast.error("Transaction Delete Failed, please Try Again");
    }
  };
    ...
    >
      <div className="bg-gray-800  xl:w-1/3 md:w-1/2 w-11/12 p-8 rounded shadow-lg overflow-auto rounded customScrollbar mt-16">
        <h2 className="text-xl font-bold mb-4">
          Are you sure You're deleting Transaction : {transaction.name}
        </h2>
